...
export const StoryProps = () => {
  ...
  }/stories/?project_id=${projectId}&limit=4&offset=${(pageChange - 1) * 4}`;
  ...
  useEffect(() => {
    setscheduledStories(story.filter((s) => s.is_scheduled === 1));
    setunscheduledStories(story.filter((s) => s.is_scheduled === 2));
  }, [story]);
